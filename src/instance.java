...
class Instance{
	...
	public static HashMap<Integer,Double> min = new HashMap<Integer,Double>();
	public static HashMap<Integer,Double> max = new HashMap<Integer,Double>();

	public Instance(String instanceClass){
		this.instanceClass = instanceClass;
		values = new ArrayList<Double>(36); 
		indexes = new ArrayList<Integer>(36);
